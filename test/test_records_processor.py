...
class TestRecordsProcessor:
    ...
    def test_process_records_json_no_exception(
        ...
        valid_records = test_data["valid_records_json"]
        ...
        assert (
            test_circ_trans_instance.process_records(valid_records, "json")
    ...
    def test_process_records_csv_no_exception(
        ...
        valid_records = test_data["valid_records_csv"]
        expected_processed_records = '[{"recordId": "49546986683135544286507457936321625675700192471156785154", "result": "Ok", "data": "YWF8TGlicmFyeSBBfE1vbnwwOTowMHwxNzowMHwyMDIzLTAxLTAxCg=="}, {"recordId": "49546986683135544286507457936321625675700192471156785154", "result": "Ok", "data": "YmJ8TGlicmFyeSBCfFR1ZXx8fDIwMjMtMDItMDIK"}, {"recordId": "49546986683135544286507457936321625675700192471156785154", "result": "Ok", "data": "Y2N8TGlicmFyeSBcfCBDICEsPXxXZWR8MDE6MDB8MjM6MDB8MjAyMy0wMy0wMwo="}]'
        assert (
            test_location_hours_instance.process_records(valid_records, "csv")
            == expected_processed_records
        )
        assert (
